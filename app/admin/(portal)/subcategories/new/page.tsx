    ...
    <div className="p-6">
      <div className="mb-6">
        <div className="text-xs text-[#818ea0] mb-1">
          <a href="/admin/subcategories" className="hover:text-[#041e42]">Subcategories</a> / New
        </div>
        <h1 className="text-2xl font-black text-[#021523]">Add Subcategory</h1>
      </div>
      <div className="bg-white rounded-xl border border-[#e5e8ec] p-6 max-w-lg">
        <form action={action} className="space-y-4">
          ...
          <div>
            ...
            <input type="text" name="name" required className={inputCls} placeholder="e.g. Gaming Laptop" />
          </div>
          <div>
            <label className={labelCls}>Slug *</label>
            <input type="text" name="slug" required className={inputCls} placeholder="e.g. gaming-laptop" />
          </div>
          <div>
            <label className={labelCls}>Category ID *</label>
            <input type="number" name="category_id" required className={inputCls} placeholder="Category ID (from Categories list)" />
          </div>
          <div className="flex gap-3 pt-2">
            <button type="submit" disabled={pending}
              ...
              {pending ? 'Saving…' : 'Create Subcategory'}
            </button>
